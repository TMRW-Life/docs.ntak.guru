...
#### `guests.*.departure` [#guests-departure]
...
##### `guests.*.scanned.firstName` [#guests-scanned-firstName]
...
##### `guests.*.scanned.lastName` [#guests-scanned-lastName]
...
##### `guests.*.scanned.birthFirstName` [#guests-scanned-birthFirstName]
...
##### `guests.*.scanned.birthLastName` [#guests-scanned-birthLastName]
...
##### `guests.*.scanned.dateOfBirth` [#guests-scanned-dateOfBirth]
...
##### `guests.*.scanned.placeOfBirth` [#guests-scanned-placeOfBirth]
...
##### `guests.*.scanned.motherFirstName` [#guests-scanned-motherFirstName]
...
##### `guests.*.scanned.motherLastName` [#guests-scanned-motherLastName]
...
##### `guests.*.scanned.nationality` [#guests-scanned-nationality]
...
##### `guests.*.scanned.gender` [#guests-scanned-gender]

Gender of the guest.

| Type                                       |        Required         |
|:-------------------------------------------|:-----------------------:|
| [`Gender`](/terminology/constants#genders) | If it's on the document |

##### `guests.*.scanned.documentType` [#guests-scanned-documentType]

Document type of the guest.

| Type                                                     | Required |
|:---------------------------------------------------------|:--------:|
| [`Document type`](/terminology/constants#document-types) |   Yes    |

##### `guests.*.scanned.documentNumber` [#guests-scanned-documentNumber]
...
##### `guests.*.manual.firstName` [#guests-manual-firstName]
...
##### `guests.*.manual.lastName` [#guests-manual-lastName]
...
##### `guests.*.manual.birthFirstName` [#guests-manual-birthFirstName]
...
##### `guests.*.manual.birthLastName` [#guests-manual-birthLastName]
...
##### `guests.*.manual.dateOfBirth` [#guests-manual-dateOfBirth]
...
##### `guests.*.manual.placeOfBirth` [#guests-manual-placeOfBirth]
...
##### `guests.*.manual.motherFirstName` [#guests-manual-motherFirstName]
...
##### `guests.*.manual.motherLastName` [#guests-manual-motherLastName]
...
##### `guests.*.manual.nationality` [#guests-manual-nationality]
...
##### `guests.*.manual.gender` [#guests-manual-gender]
...
##### `guests.*.manual.documentType` [#guests-manual-documentType]
...
##### `guests.*.manual.documentNumber` [#guests-manual-documentNumber]
...
#### `guests.*.visaNumber` [#guests-visaNumber]
...
#### `guests.*.visaDateOfEntry` [#guests-visaDateOfEntry]
...
#### `guests.*.visaPlaceOfEntry` [#guests-visaPlaceOfEntry]
