...
NTAK.TEST is wrapper for [NTAK](https://info.ntak.hu/) to provide a much simpler interface.
...
With NTAK.REST you can report the following events without making the user and/or guest to wait for us:
