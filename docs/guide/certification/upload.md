...
After you downloaded the authentication and signatory certifications from the government's NTAK system,
you can upload the of these two files along with the reporting id ("Adatszolgáltatási azonosító" in Hungarian).
...
| Name           | Description                                                                    | Type     |      Required      |
|----------------|--------------------------------------------------------------------------------|----------|:------------------:|
| authentication | The authentication certification provided by NTAK. The content of `.cer` file. | `string` | :white_check_mark: |
| signatory      | The signatory certification provided by NTAK. The content of `.cer` file.      | `string` | :white_check_mark: |
