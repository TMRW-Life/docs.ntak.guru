...
Every time when you do the following actions, we respond with the latest accommodation object:
 ...
 - [Register](/guide/accommodation/register)
 - [Retrieve](/guide/accommodation/retrieve)
 - [Update](/guide/accommodation/update)
 - [Activate](/guide/accommodation/activate)
 - [Deactivate](/guide/accommodation/deactivate)
